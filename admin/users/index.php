							...
							<div class="card">
								...
								<div class="box-body table-responsive no-padding">
                           		<table id="users" class="table table-hover table-ordered table-striped">
                                	...
                                	<tbody>
                                		<?php
                                    		$staffl = mysqli_query($conn, $stafflist);

                                    		if(! $staffl) {
                                       			die('Kon data niet inladen: '. mysqli_error($conn));
                                    		}

                                    		while($row4 = mysqli_fetch_assoc($staffl)) {
                                 		?>
                                       	<tr class="align-middle">
                                         	<td><code><?php echo htmlspecialchars($row4['id']);?></code></td>
                                           	<td class="text-center"><?php echo htmlspecialchars($row4['email']);?></a></td>
                                           	<td class="text-center"><?php echo htmlspecialchars($row4['username']);?></td>
                                           	<td class="text-center"><?php echo htmlspecialchars($row4['name']);?></td>
                                           	<td class="text-center"><?php echo htmlspecialchars($row4['firstname']);?></td>
                                           	<td class="text-center"><?php echo htmlspecialchars($row4['groupname']);?></td>
                                           	<td class="text-center"><?php echo htmlspecialchars($row4['registered']);?></td>
											<td>
												<form name="modifyuser" action="edit.php" method="get">
													<input type="hidden" name="id" value="<?php echo htmlspecialchars($row3['id']); ?>" />
													<input type="submit" value="Modify User" />
											...
											<td>
												<form name="deleteuser" id="deleteuser" action="remove.php" method="post">
													<input type="hidden" id="deleteuser" name="deleteuser" value="<?php echo htmlspecialchars($row4['id']); ?>" />
													<input type="submit" id="deleteuser" name="deleteuser" value="Delete User" />
												</form>
											</td>
                                        </tr>
                                		<?php    }
