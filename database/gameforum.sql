CREATE DATABASE  IF NOT EXISTS `gameforum` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `gameforum`;
-- MySQL dump 10.13  Distrib 8.0.18, for Win64 (x86_64)
--
-- Host: remote.flanderscraft.be    Database: gameforum
-- ------------------------------------------------------
...
CREATE TABLE `groups` (
  ...
  `groupname` varchar(45) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `settings` (
  ...
  `sitename` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
...
INSERT INTO `settings` VALUES (1,'Dream-Game');
...
CREATE TABLE `users` (
  ...
  `username` varchar(75) CHARACTER SET utf8mb4 NOT NULL,
  ...
  `gender` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
...
-- Dump completed on 2019-12-08  6:57:03
